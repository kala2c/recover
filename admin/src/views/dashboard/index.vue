<template>
  <div>
    <el-row :gutter="40" class="panel-group">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="redirectto('/depot/index')">
          <div class="card-panel-icon-wrapper icon-message">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="dashboarddata.depotcount" :duration="3000" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      ...
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="redirectto('/order/index')">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="136.45" :duration="3600" :decimals="2" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
...
export default {
  ...
  methods: {
    ...
    async getDashboard() {
      const data = await dashboardApi.dashboard()
      if (data.code !== 10000) {
        return this.$message.error('获取用户列表失败！')
      }
      this.dashboarddata = data.data.dashboarddata
    },
    redirectto(path) {
